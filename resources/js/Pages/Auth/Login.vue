            ...
            <div class="card-box w-full grid grid-cols-2">
                <div class="card-text flex items-center justify-center">
                    <div class="text-box w-3/4 break-all">
                        <h2 class="text-6xl font-extrabold mb-8">login</h2>
                        ...
                        <div class="box-btn flex w-3/4 mt-16 gap-6">
                            ...
                            <form @submit.prevent="submit" class="w-4/5">
                                <div>
                                    ...
                                    <TextInput id="email" type="email" class="mt-1 block w-full outline-none"
                                ...
                                <PrimaryButton class="flex items-center justify-center w-full h-10 mt-16" :class="{ 'opacity-25': form.processing }"
                                ...
                                <div class="flex items-center mt-16">
                                    ...
                                    <div class="relative w-full flex justify-end items-center ">
                                        <a href="register" class="border border-solid border-gray-800 hover:bg-gray-700 ml-4 p-2 text-center bg-gray-800 text-white h-9 flex items-center justify-center transition duration-1000 rounded-lg focus:outline-red-500">Inscrever-se</a>
                                    </div>
                                </div>
                            </form>
                        </div>
